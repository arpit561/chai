...
const login = () => {
  return (
    <div className=" text-white py-12 container mx-auto">
      ...
      <div className="social-login-buttons flex flex-col w-[30%] my-10 container mx-auto">
        <button
          type="button"
        ...
        <button
          type="button"
          class="text-white bg-slate-600 hover:bg-slate-700 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#050708]/50 me-2 mb-2"
        >
          <svg
